...
* `inverted_pendulum_description` - holds the sdf description of the simulated system and any other assets.

* `inverted_pendulum_gazebo` - holds gazebo specific code and configurations. Namely this is where systems end up.

* `inverted_pendulum_application` - holds ros2 specific code and configurations.
...
1. Launch the simulation
    ...
    ```bash
    ros2 launch inverted_pendulum_bringup diff_drive.launch.py
    ```
