...
class ForceCentralisedControllerCVel(BaseController):
    """
    ...
    def compute_control(
        ...
        return self._robot_velocities2(U_c_all, centroid[2]), mass_estimate, centroid_velocity_estimate #TODO robot velocities x10 bc they are way too slow for some reason...
